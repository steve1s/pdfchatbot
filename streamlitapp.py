...
def get_vectorstore(text_chunks):
    """Creates a FAISS vector store from text chunks using HuggingFace embeddings (free, local)."""
...
def get_conversation_chain(vectorstore):
    """Creates a conversational retrieval chain with a local HuggingFace model."""
